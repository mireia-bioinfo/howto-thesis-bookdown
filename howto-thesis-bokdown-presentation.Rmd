---
title: "How to survive writting your PhD thesis"
...
**{[rmarkdown]()}** is an R package and file format for making dynamic documents with R. 
...
The **{[bookdown]()}** package is built on top of R Markdown, with added features:
...
- Set `echo=FALSE` to avoid displaying your code chunk.
